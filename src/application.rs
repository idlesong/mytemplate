...
impl Application {
    ...
    fn setup_widgets(&self) {
        let builder = gtk::Builder::new_from_resource("/im/idlesong/mytemplate/shortcuts.ui");
    ...
    fn setup_gactions(&self) {
        ...
        action!(
            ...
            clone!(@weak self.window.widget as window => move |_, _| {
                let builder = gtk::Builder::new_from_resource("/im/idlesong/mytemplate/about_dialog.ui");
    ...
    fn setup_css(&self) {
        ...
        gtk::CssProvider::load_from_resource(&p, "/im/idlesong/mytemplate/style.css");
